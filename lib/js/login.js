...
$(document).ready(function() {
    ...
    $("#login").click(function(){
        ...
        var url = "http://192.168.16.58:1335/login";
        var data = {
            "nickName" : nickName,
            "passWord" : passWord
        };
...
//                    var getUrl = "http://localhost:1335/login_success/" + data.nickName + "/" + data.token;
//                    $.get(URL,callback);
                    window.location.href = "http://localhost:1335/login_success/" + nickName + "/" + token;
                }else{
